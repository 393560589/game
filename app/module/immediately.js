        ...
        return (
            <div className="immediately">
                ...
                <ul className="eve-li">
                    ...
                    <li className="clearfix">
                        ...
                        <span className="content-block pull-left">
                            <input id="address" type="text" className="pull-left" readOnly="" placeholder="城市选择特效"/>
                ...
                <p className="rules clearfix" >
                    ...
                    <span>
                        立即报价即表示同意条款信息
                        <span className="" id="http://h5.rongzhubao.cn/rules3.html" onClick={this.rulesBlock}>《商业险》</span>
                        <span className="" id="http://h5.rongzhubao.cn/rules4.html" onClick={this.rulesBlock}>《交强险》</span>
                        <span className="" id="http://h5.rongzhubao.cn/rules5.html" onClick={this.rulesBlock}>《免责申明》</span>
                    </span>
                </p>
